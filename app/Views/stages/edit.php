...
<body class="bg-gray-50 flex items-center justify-center min-h-screen">
    <form method="post" class="bg-white p-8 rounded shadow w-full max-w-md">
        ...
        <h1 class="text-2xl font-bold mb-6">Editar Coluna</h1>
        <input type="hidden" name="id" value="<?=e($stage->id)?>">
        <label class="block mb-4">Nome da Coluna
            <input type="text" name="name" value="<?=e($stage->name)?>" required class="mt-1 w-full border rounded px-3 py-2">
        </label>
