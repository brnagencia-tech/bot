...
<body class="bg-gray-50 flex items-center justify-center min-h-screen">
    <form method="post" class="bg-white p-8 rounded shadow w-full max-w-sm">
        ...
        <h1 class="text-2xl font-bold mb-6">Resetar Senha</h1>
        <label class="block mb-4">Email
            <input type="email" name="email" required class="mt-1 w-full border rounded px-3 py-2">
        </label>
        <button type="submit" class="w-full bg-blue-600 text-white py-2 rounded hover:bg-blue-700">Enviar link</button>
